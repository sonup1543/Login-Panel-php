...
$query = "SELECT * FROM persons ORDER BY id ASC;"; // Changed to DESC
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr><th>Interior Month</th><td id="modalInteriorMonth"></td></tr>
                            <tr><th>Interior Year</th><td id="modalInteriorYear"></td></tr>
                            <tr><th>Property</th><td id="modalProperty"></td></tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.view-btn').on('click', function() {
                ...
                $('#modalScope').text(rowData.Scope);
                $('#modalScopepoint').text(rowData.Scopepoint);
                $('#modalInteriorBudget').text(rowData.Interiorbuget);
                $('#modalInteriorMonth').text(rowData.Interiormonth);
                $('#modalInteriorYear').text(rowData.Interioryear);
                $('#modalProperty').text(rowData.Property);
